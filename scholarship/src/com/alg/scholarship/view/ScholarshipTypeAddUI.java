...
public class ScholarshipTypeAddUI extends IndexAdmin{
	//类中声明用到的组件
	//初始化字体
	...
	JButton addScholarshipTypeButton=new JButton("保存");
	
	public ScholarshipTypeAddUI(String username){
		super(username);
		init();
	}
	private void init(){
		...
		//按钮
		addScholarshipTypeButton.setBounds(200, 340, 180, 50);
		...
		addScholarshipTypeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Boolean b = scholarshipTypeDao.addScholarshipType(scholarshipType);
				if(b) {
					//页面转换
